...
abstract class AbstractRedisTest implements TestPropertyProvider {
    ...
    public Map<String, String> getProperties() {
        ...
        return Map.of("redis.uri", "redis://" + REDIS_CONTAINER.getHost() + ":" + REDIS_CONTAINER.getMappedPort(REDIS_PORT));
    }
    // end::container[]
}
