...
class RedisCacheWithSupplierTest implements TestPropertyProvider {
    ...
    @Test
    void testGetWithSupplierCachesValueWhenAbsent() throws ExecutionException, InterruptedException {
